        ...
        <div className="relative">
          ...
          {menuOpen && (
            <>
              ...
              />
              <div className="absolute right-0 mt-1 w-36 py-1 bg-white/90 dark:bg-surface-800/90 backdrop-blur-md rounded-lg shadow-lg border border-surface-200/50 dark:border-surface-700/50 z-50">
                <Link
                  to={`/edit/${blog._id}`}
